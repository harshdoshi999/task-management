...
import {addTask, fetchTasks} from "../apis.js"
    ...
    <div class="max-w-4xl mx-auto mt-10">
      ...
      <div class="flex justify-between items-center mb-6">
        ...
        <div class="relative w-1/4">
          <select class="block appearance-none w-full bg-white border border-gray-300 hover:border-gray-500 px-4 py-2 pr-8 rounded-lg shadow leading-tight focus:outline-none focus:shadow-outline">
      ...
      <div class="max-w-sm mt-10">
        <div class="bg-white shadow-lg rounded-lg p-6">
          <h2 class="text-2xl font-bold mb-2">Task Name</h2>
          <p class="text-gray-700 mb-4">
            This is a brief description of the task. It gives an overview of
